...
variable = tk.StringVar(
    value="fahrenheit"
)  # Variable pour stocker le choix, par défaut Fahrenheit
radio_fahrenheit = tk.Radiobutton(
    fenetre, text="Fahrenheit", variable=variable, value="fahrenheit"
)
...
)  # columnspan fusionne les deux colonnes, pady ajoute un espace vertical
