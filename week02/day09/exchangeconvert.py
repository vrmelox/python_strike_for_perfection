...
class ExchangeRates():
    ...
    def convertRates(self):
        print(f"Voici toutes les devises que nous convertissons :\n {self.rates.keys()}")
        devise = input("Entrez la devise d'arrivée, le montant et la devise de base (les trois séparés par des espaces): ").split()
        try:
